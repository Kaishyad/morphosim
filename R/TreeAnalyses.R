#TreeAnalyses.R — TreeDistances() is directly useful but needs path adapting. Dispersion() is useful for convergence diagnostics. Skip TreeLengths() and PrecisionIncrease() for now.
